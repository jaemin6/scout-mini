...
// functions for scout_msgs::msg::ScoutLightState already declared above
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = scout_msgs::msg::ScoutStatus;
    is_plain =
      (
...
static size_t _ScoutStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ScoutStatus(full_bounded, is_plain, 0);
